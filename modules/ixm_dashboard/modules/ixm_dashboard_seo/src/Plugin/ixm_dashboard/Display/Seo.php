        ...
        if (!empty($values[0]['focus_keyword'])) {
          ...
          $output['row1'] = [
            ...
            'avg' => [
              ...
              '#typeCompare' => $this->getAverageScore($node->bundle()) ? number_format($values[0]['status'] / $this->getAverageScore($node->bundle()) * 100) : 0,
              '#siteCompare' => $this->getAverageScore() ? number_format($values[0]['status'] / $this->getAverageScore() * 100) : 0,
            ],
          ];
